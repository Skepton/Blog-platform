...
function textParse(headline, text, snippet, header){
    	...
    	if (lines[i].trim().length > 0) {
    		...
    		if(lines[i].charAt(0) == '#'){
    			...
    			if(url.length > 0){
    				...
    				complete[i] = '<img class="materialboxed" src="'+url+'">';

    			}else{

    				url ="http://placehold.it/700x300&text=Click+To+Open+Image+Manager";
    				complete[i] = '<img class="" src="'+url+'">';
...
module.exports.parse = textParse;
